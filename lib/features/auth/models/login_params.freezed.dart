...
/// @nodoc
@JsonSerializable()
class _$_LoginParams with DiagnosticableTreeMixin implements _LoginParams {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'LoginParams(uid: $uid, password: $password, companyId: $companyId)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, uid, password, companyId);
...
abstract class _LoginParams implements LoginParams {
  const factory _LoginParams(
          ...
          @JsonKey(name: "companyId") required final String companyId}) =
      _$_LoginParams;
